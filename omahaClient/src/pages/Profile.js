...
const Profile = () => {
    ...
    return (
        ...
        <div className="section no-pad-bot" id="index-banner">
            ...
            <div className="row center">
            <a href="https://www.youtube.com/watch?v=9l5C8cGMueY" id="download-button" className="btn-large waves-effect waves-light orange col s6 offset-s2">Youtube video about Scoragami</a>
            </div>
        </div>
